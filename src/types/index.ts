...
export const DATE_TYPE_INFO: Record<DateType, { label: string; labelEn: string; keywords: string[] }> = {
  ISSUE: { label: '签发日期', labelEn: 'Date of Issue', keywords: ['Date of Issue', 'Issued at', 'Issued on', 'Date of Certificate', 'Issue Date', 'Issued', 'Issue', 'Issued Date', 'Certificate issued this', 'Certificate issued', 'completion date of survey on which this certificate is based', 'issud', '发证日期', '签发日期', 'Provisionally registered on', 'registered on', 'Issued * on', 'Issued at * on', 'on which this certificate is based', 'dated'] },
  EXPIRY: { label: '有效日期', labelEn: 'Date of Expiry', keywords: ['Date of Expiry', 'Expiry', 'Valid Until', 'Valid Till', 'Valid To', 'Expiration', 'Expiring', 'this Certificate is valid until', 'accepted as valid until', 'Expiry Date', 'Expires', 'expires on', 'certificate expires', 'valid until the', 'Valid until', '有效期至', '有效日期', '失效日期', '到期', '有效期限', '过期日期', 'is valid until', 'valid until', 'certificate is valid until'] },
